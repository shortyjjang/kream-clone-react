...
export default function Tabs({tabs, current, onClick, value, type = 'default'}) {
  return (
    <div className={`flex items-center overflow-auto scroll-m-0 scroll-p-0 invisible-scrollbar ${type === 'button' ? 'gap-2 text-[13px] py-3 px-4 border-b border-gray-100':' text-[15px]'}`} style={type === 'button' ? {
